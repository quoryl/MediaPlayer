...
public:
    ...
    void SetUp()override{
        s1 = new Song(wxT("someTitle"));
        s2 = new Song(wxT("someOtherTitle"), wxT("2ne1"), wxT("Crush"), 306 , wxT("/home/azrael/Music/Whisper.mp3"));
        s3 = new Song(wxT("creativeTitle"), wxT("2ne1"), wxT("Crush"), -5 , wxT("/home/azrael/Music/Whisper.mp3"));
    }
...
//here are checked setLength, setLoop, setSongPath,
